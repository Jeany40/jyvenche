...
export default function Credibility({ title, body, bullets }: CredibilityProps) {
    return (
        <section className="mt-32 glass-card relative overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                <div>
                    ...
                    <p className="mt-4 text-foreground-secondary leading-relaxed text-lg">{body}</p>
                </div>
                    ...
                    <ul className="grid grid-cols-1 gap-4">
                        {bullets.map((b) => (
                            <li key={b} className="flex gap-4 items-start group">
                                ...
                                <span className="text-foreground-secondary group-hover:text-white transition-colors">{b}</span>
                            </li>
                        ))}
                    </ul>
                ) : null}
